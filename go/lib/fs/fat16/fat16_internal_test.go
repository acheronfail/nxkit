...
var (
	...
	mockNames = []mockDirEntryNames{
		{"lower.low", "lower.low", [11]byte{0x4c, 0x4f, 0x57, 0x45, 0x52, pad, pad, pad, 0x4c, 0x4f, 0x57}, 0x18},
		{"lower.UPP", "lower.UPP", [11]byte{0x4c, 0x4f, 0x57, 0x45, 0x52, pad, pad, pad, 0x55, 0x50, 0x50}, 0x08},
		{"UPPER.low", "UPPER.low", [11]byte{0x55, 0x50, 0x50, 0x45, 0x52, pad, pad, pad, 0x4c, 0x4f, 0x57}, 0x10},
		{"UPPER.UPP", "UPPER.UPP", [11]byte{0x55, 0x50, 0x50, 0x45, 0x52, pad, pad, pad, 0x55, 0x50, 0x50}, 0x00},
		{"file.txt", "file.txt", [11]byte{0x46, 0x49, 0x4C, 0x45, pad, pad, pad, pad, 0x54, 0x58, 0x54}, 0x18},
		{"foo.tar.gz", "FOOTAR~1.GZ", [11]byte{0x46, 0x4F, 0x4F, 0x54, 0x41, 0x52, 0x7E, 0x31, 0x47, 0x5A, pad}, 0x00},
		{".conf", "CONF~1", [11]byte{0x43, 0x4F, 0x4E, 0x46, 0x7E, 0x31, pad, pad, pad, pad, pad}, 0x00},
		{"a+b=c", "A_B_C~1", [11]byte{0x41, 0x5F, 0x42, 0x5F, 0x43, 0x7E, 0x31, pad, pad, pad, pad}, 0x00},
		{"💩.png", "2FFA~1.PNG", [11]byte{0x32, 0x46, 0x46, 0x41, 0x7E, 0x31, pad, pad, 0x50, 0x4E, 0x47}, 0x00},
		{"Asakura Otome.jpeg", "ASAKUR~1.JPE", [11]byte{0x41, 0x53, 0x41, 0x4B, 0x55, 0x52, 0x7E, 0x31, 0x4A, 0x50, 0x45}, 0x00},
		{"Asakura Yume.jpeg", "ASAKUR~2.JPE", [11]byte{0x41, 0x53, 0x41, 0x4B, 0x55, 0x52, 0x7E, 0x32, 0x4A, 0x50, 0x45}, 0x00},
		{"AFILEW~1.DAT", "AFILEW~1.DAT", [11]byte{0x41, 0x46, 0x49, 0x4C, 0x45, 0x57, 0x7E, 0x31, 0x44, 0x41, 0x54}, 0x00},
	}
)
